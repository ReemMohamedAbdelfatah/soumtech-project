  ...
  case "live":
    return <div className="flex  justify-between  items-center  gap-[12px] xl:gap-[20px]   h-[45px] w-full border border-border rounded-[6.54px] px-[12px] py-[6px]">
        ...
        <div className="flex flex-col items-center gap-[2px]">
          ...
          <span className="text-[9px] xl:text-[10px] font-normal text-muted-foreground leading-[14px]">ثانية</span>
        </div>
        {/* Separator */}
        ...
        <div className="flex flex-col items-center gap-[2px]">
          ...
          <span className="text-[9px] xl:text-[10px] font-normal text-muted-foreground leading-[14px]">دقيقة</span>
        </div>
        {/* Separator */}
        <div className="flex flex-col items-center justify-center h-full">
        <div className="text-[15px] xl:text-[19.63px] font-bold text-primary leading-[100%]">:</div>
        ...
        <div className="flex flex-col items-center gap-[2px]">
          ...
          <span className="text-[9px] xl:text-[10px] font-normal text-muted-foreground leading-[14px]">ساعة</span>
        </div>
        {/* Separator */}
        <div className="flex flex-col items-center justify-center h-full">
        <div className="text-[15px] xl:text-[19.63px] font-bold text-primary leading-[100%]">:</div>
        ...
        <div className="flex flex-col items-center gap-[2px]">
          ...
          <span className="text-[10px] xl:text-[11.78px] font-light text-muted-foreground leading-[14px]">يوم</span>
        </div>
      </div>
      case "upcoming": return <div className="flex    items-center  gap-[12px] xl:gap-[45px]  h-[45px] w-full border border-border rounded-[6.54px] px-[12px] py-[6px] ">
          <div className="flex flex-col justify-center gap-[2px]">
            <span className="text-[10px] xl:text-[11px] font-normal text-primary leading-[100%]">تاريخ فتح المزاد</span>
          ...
          <div className="flex flex-col items-center gap-[2px]">
            <span className="text-[10px] xl:text-[11px] font-normal text-primary leading-[100%]">وقت فتح المزاد</span>
      ...
      case 'over': return  <div className="flex items-center justify-center  h-[45px] w-full bg-[#DC5224]  rounded-[1111px] ">
        <span className="text-[13px] xl:text-[16px] font-medium text-primary-foreground leading-[100%]">مزاد منتهي</span>
      </div>
      }
